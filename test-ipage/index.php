...
<div class="blog-masthead">
    <div class="container">
        <nav class="blog-nav">
            ...
            <a class="blog-nav-item notvisible" href="manage.php">Manage Task</a>
            <a class="blog-nav-item notvisible glyphicon  glyphicon-cog" style="float: right;" data-toggle="modal" data-target=".bs-modal-setting"></a>
            <a class="blog-nav-item notvisible" style="float: right;" ng-click="logout()"> Log out</a>

            <a class="blog-nav-item" id="btn-signup" style="float: right;" href="#signUp" data-toggle="modal" data-target=".bs-modal-sm">Sign
            up</a>
            <a class="blog-nav-item" id="btn-signin" style="float: right;" href="#signin" data-toggle="modal" data-target=".bs-modal-sm">Log
            in</a>
