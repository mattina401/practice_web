$(document).ready(function () {
    $("#btnbtnbtn").on("click", function (e) {
        console.log("clicked")
        e.preventDefault();
        var dataset1 = $("#testttitle");
        var dataset2 = $("#testtext");
        var savebtn = $(this).next(".savebtn1");
    ...
    $(".savebtn1").on("click", function (e) {
        e.preventDefault();
        var elink = $(this).prev(".editlink1");
        var dataset1 = elink.prev().prev(".datainfo1");
        var newid1 = dataset1.attr("id");
        var dataset2 = elink.prev(".datainfo2");
